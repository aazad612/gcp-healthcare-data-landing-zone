############################################################
# /mnt/data/project-factory/infra/05-domains/research/prj-res-exp-pd/main.tf
#
# Creates the GCP project for: Research ML Experiments Prod
...
module "project" {
  ...
  name               = "Research ML Experiments Prod"
  project_id         = "prj-res-exp-pd"
  org_id             = var.org_id
