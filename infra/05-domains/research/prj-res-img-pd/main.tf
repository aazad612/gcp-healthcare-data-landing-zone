############################################################
# /mnt/data/project-factory/infra/05-domains/research/prj-res-img-pd/main.tf
#
# Creates the GCP project for: Research Imaging Prod
...
module "project" {
  ...
  name               = "Research Imaging Prod"
  project_id         = "prj-res-img-pd"
  org_id             = var.org_id
