############################################################
# /mnt/data/project-factory/infra/05-domains/governance/prj-gov-atl-pd/main.tf
#
# Creates the GCP project for: Governance Atlas Prod
...
module "project" {
  ...
  name               = "Governance Atlas Prod"
  project_id         = "prj-gov-atl-pd"
  org_id             = var.org_id
