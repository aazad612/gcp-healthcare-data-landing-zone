############################################################
# /mnt/data/project-factory/infra/05-domains/governance/prj-gov-atl-np/main.tf
#
# Creates the GCP project for: Governance Atlas Nonprod
...
module "project" {
  ...
  name               = "Governance Atlas Nonprod"
  project_id         = "prj-gov-atl-np"
  org_id             = var.org_id
