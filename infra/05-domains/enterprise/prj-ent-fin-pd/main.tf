############################################################
# /mnt/data/project-factory/infra/05-domains/enterprise/prj-ent-fin-pd/main.tf
#
# Creates the GCP project for: Enterprise Finance Analytics Prod
...
module "project" {
  ...
  name               = "Enterprise Finance Analytics Prod"
  project_id         = "prj-ent-fin-pd"
  org_id             = var.org_id
