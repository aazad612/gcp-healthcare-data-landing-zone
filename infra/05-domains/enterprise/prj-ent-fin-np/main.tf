############################################################
# /mnt/data/project-factory/infra/05-domains/enterprise/prj-ent-fin-np/main.tf
#
# Creates the GCP project for: Enterprise Finance Analytics Nonprod
...
module "project" {
  ...
  name               = "Enterprise Finance Analytics Nonprod"
  project_id         = "prj-ent-fin-np"
  org_id             = var.org_id
